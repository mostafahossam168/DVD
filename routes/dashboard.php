...
use App\Http\Controllers\Dashboard\TeacherFinancialController;
...
Route::group(['middleware' => ['auth', 'dashboard.access']], function () {
    ...
    Route::get('subscriptions-financials', [TeacherFinancialController::class, 'index'])->name('subscriptions.financials');
    Route::post('subscriptions-financials/withdraw', [TeacherFinancialController::class, 'storeWithdrawal'])->name('subscriptions.financials.withdraw');

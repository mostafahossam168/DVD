@extends('dashboard.layouts.backend', ['title' => 'إضافة كوبون'])
...
<div class="dash-page">
    <div class="page-breadcrumb fade-up-ds">
        ...
        <span class="sep">/</span>
        <span class="current">إضافة كوبون</span>
    </div>
    ...
    <form action="{{ route('dashboard.coupons.store') }}" method="post" class="fade-up-ds delay-1-ds">
        @csrf
        <div class="form-card-ds">
            <div class="form-card-header-ds">
                <div class="fch-icon-ds" style="background:#fef3c7">🎫</div>
                <div>
                    <h2>بيانات الكوبون</h2>
                    <p>إنشاء كوبون خصم جديد.</p>
                </div>
            </div>
            <div class="form-card-body-ds">
                <div class="form-grid-ds">
                    <div class="form-group-ds">
                        ...
                        <input type="text" name="code" class="form-control-ds" value="{{ old('code') }}" placeholder="مثال: STUDENT2024" required>
                    ...
                    <div class="form-group-ds">
                        ...
                        <input type="number" name="value" class="form-control-ds" value="{{ old('value') }}" id="value-input" step="0.01" min="0" required>
                    ...
                    <div class="form-group-ds">
                        ...
                        <input type="number" name="min_amount" class="form-control-ds" value="{{ old('min_amount') }}" step="0.01" min="0" placeholder="اختياري">
                        @error('min_amount')<span class="form-error-ds" style="font-size:.76rem;color:#dc2626">{{ $message }}</span>@enderror
                        <small class="form-hint-ds">اتركه فارغاً إذا لم يكن هناك حد أدنى</small>
                    </div>
                    <div class="form-group-ds">
                        <label class="form-label-ds">حد الاستخدام</label>
                        <input type="number" name="usage_limit" class="form-control-ds" value="{{ old('usage_limit') }}" min="1" placeholder="اختياري">
                        @error('usage_limit')<span class="form-error-ds" style="font-size:.76rem;color:#dc2626">{{ $message }}</span>@enderror
                        <small class="form-hint-ds">اتركه فارغاً للاستخدام غير المحدود</small>
                    </div>
                    <div class="form-group-ds">
                        <label class="form-label-ds">تاريخ البداية</label>
                        <input type="date" name="start_date" class="form-control-ds" value="{{ old('start_date') }}">
                    ...
                    <div class="form-group-ds">
                        ...
                        <input type="date" name="end_date" class="form-control-ds" value="{{ old('end_date') }}">
                ...
                <div class="form-group-ds" style="grid-column:1 / -1">
                    ...
                    <textarea name="description" class="form-control-ds" rows="3">{{ old('description') }}</textarea>
            ...
            <div class="form-card-footer-ds">
                <button type="submit" class="btn-ds btn-success-ds">حفظ الكوبون</button>

...
<div class="dash-page">
    <div class="page-breadcrumb fade-up-ds">
        ...
        <span class="sep">/</span>
        <a href="{{ route('dashboard.assessment-results.index') }}">نتائج التقييمات</a>
        <span class="sep">/</span>
        <span class="current">تفاصيل النتيجة</span>
    </div>
    <div class="page-header-ds fade-up-ds">
        <h1>{{ $assessment?->title ?? '—' }}</h1>
    </div>
    <a href="{{ route('dashboard.assessment-results.index') }}" class="btn-back-ds fade-up-ds">رجوع</a>
        ...
        <div class="form-card-body-ds">
            <div class="form-grid-ds">
                ...
                <div class="form-group-ds">
                    ...
                    <p class="mb-0"><span class="assessment-summary-value">{{ $result->score }} / {{ $result->max_score }}</span></p>
                </div>
                <div class="form-group-ds">
                    <label class="form-label-ds">نوع التقييم</label>
                    <p class="mb-0">{{ $assessment?->type ?? '-' }}</p>
                </div>
                <div class="form-group-ds">
    ...
    @foreach ($questions as $index => $question)
        ...
        <div class="form-card-ds fade-up-ds mt-4">
            <div class="form-card-body-ds">
                <h5 class="mb-2" style="font-weight:600">سؤال {{ $index + 1 }} (الدرجة: {{ $mark }})</h5>

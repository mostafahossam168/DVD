@extends('dashboard.layouts.backend', ['title' => 'اضافة سؤال'])
...
<div class="dash-page">
    <div class="page-breadcrumb fade-up-ds">
        ...
        <span class="sep">/</span>
        <span class="current">اضافة سؤال جديد</span>
    </div>
    <div class="page-header-ds fade-up-ds">
        <h1>اضافة سؤال جديد</h1>
    </div>
    <a href="{{ route('dashboard.questions.index') }}" class="btn-back-ds fade-up-ds">رجوع</a>
    <x-alert-component></x-alert-component>
    <form action="{{ route('dashboard.questions.store') }}" method="post" enctype="multipart/form-data" class="fade-up-ds delay-1-ds">
        @csrf
        <div class="form-card-ds">
            <div class="form-card-header-ds">
                ...
                <div>
                    <h2>سؤال جديد</h2>
                    <p>الاختبار، النوع، السؤال والاجابات.</p>
                </div>
            </div>
            <div class="form-card-body-ds">
                <div class="form-grid-ds">
                    <div class="form-group-ds">
                        ...
                        <input type="text" name="question" class="form-control-ds" value="{{ old('question') }}">
                    ...
                    <div class="form-group-ds">
                        ...
                        <select name="type" id="type" class="form-control-ds">
                            <option value="">-- اختر --</option>
                            <option value="mcq" @selected(old('type') == 'mcq')>اخيارى</option>
                            <option value="text" @selected(old('type') == 'text')>مقالى</option>
                        </select>
                    ...
                    <div class="form-group-ds" id="text_answer">
                        ...
                        <input type="text" name="correct_answer" class="form-control-ds" value="{{ old('correct_answer') }}">
                        @error('correct_answer')<span class="form-error-ds">{{ $message }}</span>@enderror
                    </div>
                    <div class="form-group-ds">
                        <label class="form-label-ds">الدرجة</label>
                        <input type="number" name="grade" class="form-control-ds" value="{{ old('grade') }}">
                ...
                <div class="form-group-ds" id="multiple_chosse">
                    ...
                    <div class="d-flex gap-2 align-items-center mb-2 mcq-item flex-wrap">
                        <span>1-</span>
                        <input type="text" name="answers[]" class="form-control-ds" style="max-width:220px">

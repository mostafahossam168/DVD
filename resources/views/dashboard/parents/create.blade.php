@extends('dashboard.layouts.backend', ['title' => 'إضافة ولي أمر'])
...
<div class="dash-page">
    <div class="page-breadcrumb fade-up-ds">
        ...
        <span class="sep">/</span>
        <span class="current">إضافة ولي أمر جديد</span>
    </div>
    ...
    <form action="{{ route('dashboard.parents.store') }}" method="post" enctype="multipart/form-data" class="fade-up-ds delay-1-ds">
        @csrf
        <div class="form-card-ds">
            <div class="form-card-header-ds">
                ...
                <div>
                    ...
                    <p>إدخال بيانات ولي أمر جديد وربطه بأبنائه.</p>
                </div>
            </div>
                    ...
                    <div class="form-group-ds" style="grid-column:1/-1">
                        ...
                        <select name="children[]" class="form-control-ds" multiple size="6">
                            @foreach($students as $student)
                                <option value="{{ $student->id }}" @selected(collect(old('children', []))->contains($student->id))>

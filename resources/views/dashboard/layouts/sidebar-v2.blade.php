    ...
    <div class="sidebar-scroll">
        ...
        @can('read_settings')
            ...
            <div class="nav-section">
                ...
                <a href="#" class="nav-item nav-item-toggle {{ $settingsActive ? 'active' : '' }}"
                    data-bs-toggle="collapse" data-bs-target="#collapse-settings-v2"
                ...
                <div id="collapse-settings-v2" class="collapse nav-collapse {{ $settingsActive ? 'show' : '' }}">
                    <a href="{{ route('dashboard.settings') }}"
                        class="nav-item nav-item-sub {{ request()->routeIs('dashboard.settings') ? 'active' : '' }}">
                    ...
                    <a href="{{ route('dashboard.pages.edit', 'about') }}"
                        class="nav-item nav-item-sub {{ request()->routeIs('dashboard.pages.edit') && $currentStaticPage === 'about' ? 'active' : '' }}">
                    ...
                    <a href="{{ route('dashboard.pages.edit', 'vision') }}"
                        class="nav-item nav-item-sub {{ request()->routeIs('dashboard.pages.edit') && $currentStaticPage === 'vision' ? 'active' : '' }}">
                        <div class="ni-icon"><i class="fa-solid fa-circle-dot"></i></div>
                        <span class="ni-label">رؤيتنا</span>
                    </a>
                    <a href="{{ route('dashboard.pages.edit', 'team') }}"
                        class="nav-item nav-item-sub {{ request()->routeIs('dashboard.pages.edit') && $currentStaticPage === 'team' ? 'active' : '' }}">
                        <div class="ni-icon"><i class="fa-solid fa-circle-dot"></i></div>
                        <span class="ni-label">فريق العمل</span>
                    </a>
                    <a href="{{ route('dashboard.pages.edit', 'faq') }}"
                        class="nav-item nav-item-sub {{ request()->routeIs('dashboard.pages.edit') && $currentStaticPage === 'faq' ? 'active' : '' }}">
                        <div class="ni-icon"><i class="fa-solid fa-circle-dot"></i></div>
                        <span class="ni-label">الأسئلة الشائعة</span>
                    </a>
                    <a href="{{ route('dashboard.pages.edit', 'privacy') }}"
                        class="nav-item nav-item-sub {{ request()->routeIs('dashboard.pages.edit') && $currentStaticPage === 'privacy' ? 'active' : '' }}">
                        <div class="ni-icon"><i class="fa-solid fa-circle-dot"></i></div>
                        <span class="ni-label">سياسة الخصوصية</span>
                    </a>
                    <a href="{{ route('dashboard.pages.edit', 'terms') }}"
                        class="nav-item nav-item-sub {{ request()->routeIs('dashboard.pages.edit') && $currentStaticPage === 'terms' ? 'active' : '' }}">
                        <div class="ni-icon"><i class="fa-solid fa-circle-dot"></i></div>
                        <span class="ni-label">الشروط والأحكام</span>
                    </a>
                    <a href="{{ route('dashboard.pages.edit', 'usage') }}"
                        class="nav-item nav-item-sub {{ request()->routeIs('dashboard.pages.edit') && $currentStaticPage === 'usage' ? 'active' : '' }}">
                        <div class="ni-icon"><i class="fa-solid fa-circle-dot"></i></div>
        ...
        <div class="nav-section">
            ...
            @can('read_admins')
                <a href="{{ route('dashboard.admins.index') }}"
                    class="nav-item {{ request()->routeIs('dashboard.admins.*') ? 'active' : '' }}">
                    ...
                    @if ($adminsCount > 0)
                        <span class="ni-count">{{ $adminsCount }}</span>
                    @endif
                </a>
            @endcan
            @can('read_teachers')
            ...
            @can('read_roles')
                <a href="{{ route('dashboard.roles.index') }}"
                    class="nav-item {{ request()->routeIs('dashboard.roles.*') ? 'active' : '' }}">
        ...
        <div class="nav-section">
            ...
            @can('read_stages')
                <a href="{{ route('dashboard.stages.index') }}"
                    class="nav-item {{ request()->routeIs('dashboard.stages.*') ? 'active' : '' }}">
                    ...
                    @if ($stagesCount > 0)
                        <span class="ni-count">{{ $stagesCount }}</span>
                    @endif
                </a>
            @endcan
            @can('read_grades')
                <a href="{{ route('dashboard.grades.index') }}"
                    class="nav-item {{ request()->routeIs('dashboard.grades.*') ? 'active' : '' }}">
            ...
            @can('read_subjects')
                <a href="{{ route('dashboard.subjects.index') }}"
                    class="nav-item {{ request()->routeIs('dashboard.subjects.*') ? 'active' : '' }}">
                    ...
                    @if ($subjectsCount > 0)
                        <span class="ni-count">{{ $subjectsCount }}</span>
                    @endif
                </a>
            @endcan
            @can('read_lectuers')
                <a href="{{ route('dashboard.lectuers.index') }}"
                    class="nav-item {{ request()->routeIs('dashboard.lectuers.*') ? 'active' : '' }}">
                    ...
                    @if ($lecturesCount > 0)
                        <span class="ni-count">{{ $lecturesCount }}</span>
                    @endif
                </a>
            @endcan
            @can('read_lectuers')
                <a href="{{ route('dashboard.online-meetings.index') }}"
                    class="nav-item {{ request()->routeIs('dashboard.online-meetings.*') ? 'active' : '' }}">
            ...
            @can('read_materials')
                <a href="{{ route('dashboard.materials.index') }}"
                    class="nav-item {{ request()->routeIs('dashboard.materials.*') ? 'active' : '' }}">
        ...
        <div class="nav-section">
            ...
            @can('read_subscriptions')
                ...
                <a href="{{ route('dashboard.payments.index') }}"
                    ...
                    <div class="ni-icon"><i class="fa-solid fa-wallet"></i></div>
                    <span class="ni-label">المدفوعات</span>
                </a>
                ...
                @can('update_subscriptions')
                    <a href="{{ route('dashboard.subscriptions-pending') }}"
                        class="nav-item {{ request()->routeIs('dashboard.subscriptions-pending') ? 'active' : '' }}">
                        ...
                        @if ($pendingCount > 0)
                            <span class="ni-count new">{{ $pendingCount }}</span>
                        @endif
                    </a>
                @endcan
            @endcan
            @can('read_payment_methods')
                <a href="{{ route('dashboard.payment-methods.index') }}"
                    class="nav-item {{ request()->routeIs('dashboard.payment-methods.*') ? 'active' : '' }}">
                    <div class="ni-icon"><i class="fa-solid fa-credit-card"></i></div>
        ...
        <div class="nav-section">
            ...
            @can('read_assessment_results')
                <a href="{{ route('dashboard.assessment-results.index') }}"
                    class="nav-item {{ request()->routeIs('dashboard.assessment-results.*') ? 'active' : '' }}">
                    <div class="ni-icon"><i class="fa-solid fa-list-check"></i></div>
                    <span class="ni-label">نتائج التقييمات</span>
                </a>
            @endcan
            @can('read_course_reviews')
                <a href="{{ route('dashboard.course-reviews.index') }}"
                    class="nav-item {{ request()->routeIs('dashboard.course-reviews.*') ? 'active' : '' }}">
            ...
            @can('read_contacts')
                <a href="{{ route('dashboard.contacts.index') }}"
                    class="nav-item {{ request()->routeIs('dashboard.contacts.*') ? 'active' : '' }}">
                    ...
                    @if ($contactsCount > 0)
                        <span class="ni-count new">{{ $contactsCount }}</span>
                    @endif
                </a>
            @endcan
            @can('read_coupons')
                <a href="{{ route('dashboard.coupons.index') }}"
                    class="nav-item {{ request()->routeIs('dashboard.coupons.*') ? 'active' : '' }}">
            ...
            @can('read_assessments')
                <a href="{{ route('dashboard.assessments.index') }}"
                    class="nav-item {{ request()->routeIs('dashboard.assessments.*') ? 'active' : '' }}">
                    <div class="ni-icon"><i class="fa-solid fa-file-pen"></i></div>
                    <span class="ni-label">التقييمات</span>
                </a>
            @endcan
            @can('read_question_bank')
                <a href="{{ route('dashboard.question-bank.index') }}"
                    class="nav-item {{ request()->routeIs('dashboard.question-bank.*') ? 'active' : '' }}">
                    <div class="ni-icon"><i class="fa-solid fa-database"></i></div>
                    <span class="ni-label">أسئلة التقييمات</span>
                </a>
            @endcan
        </div>
    </div>
            ...
            <div class="admin-avatar">
                @if (auth()->user()->image)
                    <img src="{{ display_file(auth()->user()->image) }}"
                        alt="{{ auth()->user()->full_name ?? auth()->user()->f_name }}" class="avatar-img-v2">
                @else

@extends('dashboard.layouts.backend', ['title' => 'إضافة طالب'])
...
<div class="dash-page">
    <div class="page-breadcrumb fade-up-ds">
        ...
        <span class="sep">/</span>
        <span class="current">إضافة طالب جديد</span>
    </div>
    ...
    <a href="{{ route('dashboard.students.index') }}" class="btn-back-ds fade-up-ds">
    ...
    <form action="{{ route('dashboard.students.store') }}" method="post" enctype="multipart/form-data" class="fade-up-ds delay-1-ds">
        @csrf
        <div class="form-card-ds">
            <div class="form-card-header-ds">
                ...
                <div>
                    <h2>بيانات الطالب</h2>
                    <p>إدخال بيانات طالب جديد في النظام.</p>
                </div>
            </div>
            ...
            <div class="form-card-footer-ds">
                ...
                <a href="{{ route('dashboard.students.index') }}" class="btn-ds btn-secondary-ds">إلغاء</a>
            </div>
        </div>
    </form>
</div>

    ...
    <div class="quick-stats-v2">
        ...
        <a href="{{ route('dashboard.subscriptions-pending') }}" class="qs-card-v2 c-gold anim-v2 d4-v2">
            ...
            <div class="qs-info-v2">
                ...
                <div class="qs-change-v2 {{ ($pendingCount ?? 0) > 0 ? 'down' : 'up' }}">
                    {{ ($pendingCount ?? 0) > 0 ? '⚠ تحتاج مراجعة' : 'لا يوجد' }}</div>
            </div>
        </a>
    </div>
    ...
    <div class="main-grid-v2">
        @can('read_admins')
            <a href="{{ route('dashboard.admins.index') }}" class="stat-card-v2 sc-blue anim-v2 d1-v2">
                ...
                <div class="stat-bar-v2">
                    <div class="stat-bar-fill-v2" style="width:{{ $adminsCount ? min(100, $adminsCount * 20) : 0 }}%"></div>
                </div>
        ...
        @can('read_students')
            <a href="{{ route('dashboard.students.index') }}" class="stat-card-v2 sc-purple anim-v2 d3-v2">
                ...
                <div class="stat-bar-v2">
                    <div class="stat-bar-fill-v2" style="width:{{ $studentsCount ? min(100, $studentsCount * 25) : 0 }}%">
                    </div>
                </div>
                <div class="stat-footer-v2">
        ...
        @can('read_stages')
            <a href="{{ route('dashboard.stages.index') }}" class="stat-card-v2 sc-orange anim-v2 d4-v2">
                ...
                <div class="stat-bar-v2">
                    <div class="stat-bar-fill-v2" style="width:100%"></div>
                </div>
                <div class="stat-footer-v2">
        ...
        @can('read_subjects')
            <a href="{{ route('dashboard.subjects.index') }}" class="stat-card-v2 sc-teal anim-v2 d5-v2">
                ...
                <div class="stat-bar-v2">
                    <div class="stat-bar-fill-v2" style="width:{{ $subjectsCount ? min(100, $subjectsCount * 33) : 0 }}%">
                    </div>
                </div>
                <div class="stat-footer-v2">
        ...
        @can('read_lectuers')
            <a href="{{ route('dashboard.lectuers.index') }}" class="stat-card-v2 sc-rose anim-v2 d6-v2">
                ...
                <div class="stat-bar-v2">
                    <div class="stat-bar-fill-v2" style="width:{{ $lecturesCount ? min(100, $lecturesCount * 35) : 0 }}%">
                    </div>
                </div>
                <div class="stat-footer-v2">
                    <span class="stat-link-v2">عرض جميع الدروس ←</span>
                    <span class="mini-badge-v2" style="background:#fff1f2;color:#e11d48">{{ $lecturesCount ?? 0 }}
                        منشور</span>
                </div>
            </a>
        @endcan
        @can('read_roles')
            <a href="{{ route('dashboard.roles.index') }}" class="stat-card-v2 sc-indigo anim-v2 d7-v2">
                ...
                <div class="stat-bar-v2">
                    <div class="stat-bar-fill-v2" style="width:{{ $rolesCount ? min(100, $rolesCount * 50) : 0 }}%"></div>
                </div>
                <div class="stat-footer-v2">
        ...
        @can('read_contacts')
            <a href="{{ route('dashboard.contacts.index') }}" class="stat-card-v2 sc-gold anim-v2 d8-v2">
                ...
                <div class="stat-bar-v2">
                    <div class="stat-bar-fill-v2" style="width:{{ $contactsCount ? min(100, $contactsCount * 25) : 0 }}%">
                    </div>
                </div>
                <div class="stat-footer-v2">
                    <span class="stat-link-v2">عرض جميع الرسائل ←</span>
                    <span class="mini-badge-v2"
                        style="background:#fffbeb;color:#d97706">{{ ($contactsCount ?? 0) > 0 ? 'جديد' : '—' }}</span>
                </div>
            </a>
        @endcan
        @can('read_settings')
            <a href="{{ route('dashboard.settings') }}" class="stat-card-v2 settings-card-v2 anim-v2">
                ...
                <div class="stat-bar-v2">
                    <div class="stat-bar-fill-v2" style="width:80%;background:rgba(255,255,255,.4)"></div>
                </div>
                <div class="stat-footer-v2">
            ...
            <div class="pending-list-v2">
                @forelse($pendingSubscriptions ?? collect() as $item)
                    <div class="pending-item-v2">
                        <div class="act-avatar-v2" style="background:linear-gradient(135deg,#7c3aed,#a78bfa)">
                            {{ mb_substr($item->user->name ?? '—', 0, 1) }}</div>
